...
<form id="write-form" class="body-item form" method="post">
    <table class="form-item table">
        ...
        <tbody>
        <tr>
            <td><label><input class="property-full-width" type="text" name="title" maxlength="100" placeholder="제목"></label></td>
        </tr>
        <tr>
            <td><label><textarea id="textarea2" class="property-full-width" name="content" maxlength="10000" placeholder=""></textarea></label></td>
        </tr>
        </tbody>
        <tfoot>
        <tr>
